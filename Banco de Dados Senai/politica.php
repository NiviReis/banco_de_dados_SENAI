...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="incs/rodape.css">
...
.botaoSalva {
  ...
  display: inline-block; /* Torne-o um elemento em linha */
  font-size: 16px; /* Tamanho da fonte */
  margin: 10px 5px; /* Margens externas */
...
.botaoSalva:focus {
  ...
  box-shadow: 0 0 5px rgba(52, 152, 219, 0.7); /* Adicione uma sombra ao foco */
}

/* Estilo para um botão ativo (por exemplo, quando clicado) */
.botaoSalva:active {
  background-color: #1c6ca9; /* Cor de fundo quando pressionado */
}
...
.header2 {
    background-color: #007BDF; /* Cor do Senai */
...
<?php
        ...
        $query = "SELECT conteudo FROM texto_div WHERE id = 1";
    ...
    <div id="textoContainer" class="meuTexto">
    ...
    campoTexto.style.display = "block";
        ...
        function salvarTexto() {
            ...
            xhttp.open("POST", "politica.php", true);
