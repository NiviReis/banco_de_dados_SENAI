...
<body>
    ...
    <table>
        ...
        <tbody id="tabelaCorpo">
            ...
            $sql = ("SELECT reservas.cod_reserva, pessoa.nome, ambiente.nome_ambiente, reservas.status_reserva, reservas.turno_reserva, reservas.data_solicitacao, reservas.data_reserva, reservas.horario 
            FROM reservas 
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>
                            ...
                            <input type='hidden' name='cod_reserva' value='" . $row['cod_reserva'] . "'>
